...
- ### gulp.watch()
  ...
  用于监听文件变化，文件一修改就会执行指定的任务。在例子中，通过监听`./scss/*.scss`文件，一旦文件发生修改就会执行任务sass。
...
<img src="D:\project\gulp4_cli\readme_doc\C8B5E8A3-ED24-457b-80B3-052F3A597B3F.png" alt="https://ask.qcloudimg.com/http-save/yehe-3604759/sxb5lktc93.jpeg?imageView2/2/w/1620"  />
