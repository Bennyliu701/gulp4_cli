 ...
 */
var Profile = {
    RELEASE_TAG: '/* @echo RELEASE_TAG */', // 当前环境名称
    NODE_ENV: '/* @echo NODE_ENV */', // 当前环境名称
    BASE_API: '/* @echo BASE_API */', // 基础请求Api地址
    HOME_ROOT: '/* @echo HOME_ROOT */', // 当前环境下主页地址
    STATIC_ROOT: '/* @echo STATIC_ROOT */', // 当前环境下静态资源地址
    COMMON_ROOT: '/* @echo COMMON_ROOT */', // 当前环境下公共静态资源地址
